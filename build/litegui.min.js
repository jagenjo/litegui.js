...
f.callback(this.data)});d.parent&&(d.parent.root?$(d.parent.root).append(e):$(d.parent).append(e))};LiteGUI.Slider=function(a,b){function d(a){var c=h.getClientRects()[0].width,d=b.min||0;l.setValue(a/c*((b.max||1)-d)+d)}function e(a){var c=h.getClientRects()[0];d((void 0===a.x?a.pageX:a.x)-c.left);a.preventDefault();return!1}function f(a){document.removeEventListener("mousemove",e);document.removeEventListener("mouseup",f);a.preventDefault();return!1}b=b||{};var h=document.createElement("canvas");
h.className="slider "+(b.extraclass?b.extraclass:"");h.width=100;h.height=1;h.style.position="relative";h.style.width="calc( 100% - 2em )";h.style.height="1.2em";this.root=h;var l=this;this.value=a;this.setValue=function(a){var c=h.getContext("2d"),d=b.min||0,e=b.max||1;a<d?a=d:a>e&&(a=e);d=(a-d)/(e-d);c.clearRect(0,0,h.width,h.height);c.fillStyle="#999";c.fillRect(0,0,h.width*d,h.height);c.fillStyle="#DA2";c.fillRect(h.width*d-1,0,2,h.height);a!=this.value&&(this.value=a,$(this.root).trigger("change",
a))};h.addEventListener("mousedown",function(a){var c;a.offsetX?c=a.offsetX:a.layerX&&(c=a.layerX);d(c);document.addEventListener("mousemove",e);document.addEventListener("mouseup",f)});this.setValue(a)};LiteGUI.LineEditor=function(a,b){function d(a){return[n.width*((k.xrange[1]-k.xrange[0])*a[0]+k.xrange[0]),n.height*((k.yrange[1]-k.yrange[0])*a[1]+k.yrange[0])]}function e(a){return[(a[0]/n.width-k.xrange[0])/(k.xrange[1]-k.xrange[0]),(a[1]/n.height-k.yrange[0])/(k.yrange[1]-k.yrange[0])]}function f(a){var c=
n.getBoundingClientRect(),b=a.clientX-c.left,g=a.clientY-c.top;0>b?b=0:b>n.width&&(b=n.width);0>g?g=0:g>n.height&&(g=n.height);if(-1!=q&&m([a.clientX-c.left,a.clientY-c.top],[b,g])>0.5*n.height)k.value.splice(q,1),h(a);else{c=e([-(t[0]-b),t[1]-g]);if(-1!=q){var d=k.xrange[0],f=k.xrange[1];k.no_trespassing&&(0<q&&(d=k.value[q-1][0]),q<k.value.length-1&&(f=k.value[q+1][0]));var s=k.value[q];s[0]+=c[0];s[1]+=c[1];s[0]<d?s[0]=d:s[0]>f&&(s[0]=f);s[1]<k.yrange[0]?s[1]=k.yrange[0]:s[1]>k.yrange[1]&&(s[1]=
k.yrange[1])}p();k.redraw();t[0]=b;t[1]=g;l();a.preventDefault();a.stopPropagation()}}function h(a){q=-1;k.redraw();$(document).unbind("mousemove",f);$(document).unbind("mouseup",h);l();a.preventDefault();a.stopPropagation()}function l(){b.callback?b.callback.call(k,k.value):$(k).change()}function m(a,c){return Math.sqrt(Math.pow(c[0]-a[0],2)+Math.pow(c[1]-a[1],2))}function p(){var a=null;-1!=q&&(a=k.value[q]);k.value.sort(function(a,c){return a[0]>c[0]});a&&(q=k.value.indexOf(a))}b=b||{};var k=document.createElement("div");
...
n;$(n).bind("mousedown",function(a){$(document).bind("mousemove",f);$(document).bind("mouseup",h);for(var c=n.getBoundingClientRect(),b=a.clientX-c.left,c=a.clientY-c.top,g=n.height-c,l=1E5,v=-1,s=0;s<k.value.length;s++){var u=d(k.value[s]),u=m([b,g],u);u<l&&8>u&&(l=u,v=s)}q=v;-1==q&&(g=e([b,n.height-c]),k.value.push(g),p(),q=k.value.indexOf(g));t=[b,c];k.redraw();a.preventDefault();a.stopPropagation()});$(k).resize(function(a){n.width=$(this).width();n.height=$(this).height();k.redraw()});k.getValueAt=
function(a){if(a<k.xrange[0]||a>k.xrange[1])return k.defaulty;for(var c=[k.xrange[0],k.defaulty],b=0,b=0;b<k.value.length;b+=1){var g=k.value[b];if(a==g[0])return g[1];if(a<g[0])return b=(a-c[0])/(g[0]-c[0]),c[1]*(1-b)+g[1]*b;c=g}g=[k.xrange[1],k.defaulty];b=(a-c[0])/(g[0]-c[0]);return c[1]*(1-b)+g[1]*b};k.resample=function(a){var c=[];a=(k.xrange[1]-k.xrange[0])/a;for(var b=k.xrange[0];b<=k.xrange[1];b+=a)c.push(k.getValueAt(b));return c};k.addValue=function(a){for(var c=0;c<k.value;c++)if(!(k.value[c][0]<
a[0])){k.value.splice(c,0,a);redraw();return}k.value.push(a);redraw()};var q=-1;k.redraw=function(){var a=n.getContext("2d");a.setTransform(1,0,0,1,0,0);a.translate(0,n.height);a.scale(1,-1);a.fillStyle=k.bgcolor;a.fillRect(0,0,n.width,n.height);a.strokeStyle=k.linecolor;a.beginPath();var c=d([k.xrange[0],k.defaulty]);a.moveTo(c[0],c[1]);for(var b in k.value)c=k.value[b],c=d(c),a.lineTo(c[0],c[1]);c=d([k.xrange[1],k.defaulty]);a.lineTo(c[0],c[1]);a.stroke();for(b=0;b<k.value.length;b+=1)c=k.value[b],
c=d(c),a.fillStyle=q==b?"white":k.pointscolor,a.beginPath(),a.arc(c[0],c[1],q==b?4:2,0,2*Math.PI),a.fill();if(k.show_samples){var g=k.resample(k.show_samples);a.fillStyle="#888";for(b=0;b<g.length;b+=1)c=[(k.xrange[1]-k.xrange[0])/k.show_samples*b+k.xrange[0],g[b]],c=d(c),a.beginPath(),a.arc(c[0],c[1],2,0,2*Math.PI),a.fill()}};var t=[0,0];k.redraw();return k}})();
...
d>a.max&&(d=a.max);null!=a.min&&d<a.min&&(d=a.min);l.value=a.precision?d.toFixed(a.precision):(1E3*d<<0)/1E3;a.units&&(l.value+=a.units);$(l).change()}a=a||{};var e=document.createElement("div");e.className="dragger "+(a.extraclass?a.extraclass:"");this.root=e;var f=document.createElement("span");f.className="inputfield "+(a.extraclass?a.extraclass:"")+(a.full?" full":"");a.disabled&&(f.className+=" disabled");e.appendChild(f);var h=a.dragger_class||"full",l=document.createElement("input");l.className=
"text number "+(h?h:"");l.value=b+(a.units?a.units:"");l.tabIndex=a.tab_index;this.input=l;e.input=l;a.disabled&&(l.disabled=!0);a.tab_index&&(l.tabIndex=a.tab_index);f.appendChild(l);this.setValue=function(a){$(l).val(a).trigger("change")};$(l).bind("keydown",function(a){if(38==a.keyCode)d(1,a);else if(40==a.keyCode)d(-1,a);else return;a.stopPropagation();a.preventDefault();return!0});var m=document.createElement("div");m.className="drag_widget";a.disabled&&(m.className+=" disabled");f.appendChild(m);
e.dragger=m;$(m).bind("mousedown",function(b){$(document).unbind("mousemove",c);$(document).unbind("mouseup",g);a.disabled||($(document).bind("mousemove",c),$(document).bind("mouseup",g),m.data=[b.screenX,b.screenY],$(e).trigger("start_dragging"));b.stopPropagation();b.preventDefault()})}})();
...
document.createElement("li");b.className="ltreeitem";a.id&&(b.className+=" ltreeitem-"+a.id,b.dataset.item_id=a.id);b.data=a;a.DOM=b;c=c||this.options;var d=document.createElement("div");d.className="ltreeitemtitle";a.className&&(d.className+=" "+a.className);d.innerHTML="<span class='precontent'></span><span class='incontent'>"+(a.content||a.id||"")+"</span><span class='postcontent'></span>";b.appendChild(d);b.title_element=d;var e=$(b).find(".ltreeitemtitle .incontent");e.click(function(a){a=this.parentNode;
var c=a.parentNode;a._editing||($(l.root).removeClass("selected"),$(l.root).find(".ltreeitemtitle.selected").removeClass("selected"),a.classList.add("selected"),$(l.root).trigger("item_selected",[c.data,c]),c.callback&&c.callback.call(l,c))});e.dblclick(function(a){var c=this.parentNode;$(l.root).trigger("item_dblclicked",[c.data,c]);if(!this._editing&&l.options.allow_rename){this._editing=!0;this._old_name=this.innerHTML;var b=this;this.innerHTML="<input type='text' value='"+this.innerHTML+"' />";
var d=$(this).find("input")[0];$(d).blur(function(a){var d=a.target.value;setTimeout(function(){b.innerHTML=d},1);delete b._editing;$(l.root).trigger("item_renamed",[b._old_name,d,c]);delete b._old_name});$(d).bind("keydown",function(a){13==a.keyCode&&$(this).blur()});$(d).focus();a.preventDefault()}});e[0].addEventListener("contextmenu",function(a){if(l.onContextMenu&&2==a.button&&l.onContextMenu)l.onContextMenu(a);a.preventDefault();return!1});e=document.createElement("ul");e.className="ltreeitemchildren";
b.children_element=e;b.list=e;if(a.children)for(var f in a.children){var h=this.createTreeItem(a.children[f],c);e.appendChild(h)}b.appendChild(e);this.updateListBox(b);var l=this;d.draggable=!0;d.addEventListener("dragstart",function(a){a.dataTransfer.setData("node-id",this.parentNode.id)});d.addEventListener("dragenter",function(a){d.classList.add("dragover");a.preventDefault()});d.addEventListener("dragleave",function(a){d.classList.remove("dragover");a.preventDefault()});d.addEventListener("dragover",
function(a){a.preventDefault()});d.addEventListener("drop",function(a){$(d).removeClass("dragover");a.preventDefault();var c=a.dataTransfer.getData("node-id");if(""!=c)try{l.moveItem(c,this.parentNode.id)&&$(l.root).trigger("item_moved",[l.getItem(c),l.getItem(this.parentNode.id)])}catch(b){console.error("Error: "+b)}else $(l.root).trigger("drop_on_item",[this,a])});return b};b.prototype.filterByName=function(a){for(var c=this.root.querySelectorAll(".ltreeitemtitle .incontent"),b=0;b<c.length;b++){var d=
c[b];if(d){var e=d.innerHTML,d=d.parentNode;a&&-1==e.indexOf(a)?(d.style.display="none",d.parentNode.style.paddingLeft=0):(d.style.display="block",d.parentNode.style.paddingLeft=null)}}};b.onClickBox=function(a){a=this.children_element;a.style.display="none"==a.style.display?"block":"none"};b.prototype.getItem=function(a){a=this.root.querySelector(".ltreeitem-"+a);if(!a)return null;if(!a.classList.contains("ltreeitem"))throw"this node is not a tree item";return a};b.prototype.expandItem=function(a){(a=
this.getItem(a))&&a.listbox&&listbox.setValue(!0)};b.prototype.contractItem=function(a){(a=this.getItem(a))&&a.listbox&&listbox.setValue(!1)};b.prototype.setSelectedItem=function(a){if(a){a=this.getItem(a);if(!a)return null;if(a.classList.contains("selected"))return a;$(this.root).removeClass("selected");$(this.root).find(".ltreeitemtitle.selected").removeClass("selected");$(a.title_element).addClass("selected");return a}$(this.root).removeClass("selected");$(this.root).find(".ltreeitemtitle.selected").removeClass("selected")};
b.prototype.getSelectedItem=function(){return this.root.querySelector(".ltreeitemtitle.selected")};b.prototype.insertItem=function(a,c,b,d){var e=this.root_item;if(c&&(e="string"==typeof c?this.getItem(c):c,!e))return null;if(!e.classList.contains("ltreeitem"))throw"this node is not a tree item";a=this.createTreeItem(a,d);void 0==b?e.list.appendChild(a):e.list.insertBefore(a,e.list.childNodes[b]);this.updateListBox(e);return a};b.prototype.updateListBox=function(a){if(!a.listbox){var c=a.title_element.querySelector(".precontent"),
g=LiteGUI.createLitebox(!0,b.onClickBox.bind(a));g.setEmpty(!0);c.appendChild(g);a.listbox=g}(c=this.getChildren(a))&&(c.length?a.listbox.setEmpty(!1):a.listbox.setEmpty(!0))};b.prototype.getChildren=function(a){"string"==typeof a&&this.getItem(a);if(!a||!a.list)return null;a=a.list.childNodes;var c=[],b;for(b in a){var d=a[b];"li"==d.localName&&d.classList.contains("ltreeitem")&&c.push(d)}return c};b.prototype.getParent=function(a){"string"==typeof a&&this.getItem(a);if(!a)return null;for(a=a.parentNode;a;){if(a.classList.contains("ltreeitem"))return a;
...
Inspector.prototype.addNumber=function(b,a,c){c=this.processOptions(c);c.step||(c.step=0.1);a=a||0;var g=this;this.values[b]=a;var d=this.createWidget(b,"",c);this.append(d,c);c.extraclass="full";c.tab_index=this.tab_index;c.full=!0;this.tab_index++;a=new LiteGUI.Dragger(a,c);a.root.style.width="calc( 100% - 3px )";$(d).find(".wcontent").append(a.root);$(a.root).bind("start_dragging",function(a){this.callback_before&&this.callback_before.call(d)}.bind(c));$(d).find("input").change(function(a){g.values[b]=
a.target.value;if(c.callback){var f=c.callback.call(d,parseFloat(a.target.value));"number"==typeof f&&$(this).val(f)}$(d).trigger("wchange",a.target.value);if(g.onchange)g.onchange(b,a.target.value,d)});d.setValue=function(a){$(this).find("input").val(a).change()};return d};
Inspector.prototype.addVector2=function(b,a,c){function g(a){this.callback_before&&this.callback_before(a)}c=this.processOptions(c);c.step||(c.step=0.1);a=a||[0,0];var d=this;this.values[b]=a;var e=this.createWidget(b,"",c);c.step=c.step||0.1;c.tab_index=this.tab_index;c.full=!0;this.tab_index++;var f=new LiteGUI.Dragger(a[0],c);f.root.style.marginLeft=0;f.root.style.width="calc( 50% - 3px )";$(e).find(".wcontent").append(f.root);c.tab_index=this.tab_index;this.tab_index++;var h=new LiteGUI.Dragger(a[1],
c);h.root.style.width="calc( 50% - 3px )";$(e).find(".wcontent").append(h.root);$(f.root).bind("start_dragging",g.bind(c));$(h.root).bind("start_dragging",g.bind(c));$(e).find("input").change(function(a){a=[];for(var f=$(e).find("input"),g=0;g<f.length;g++)a.push(parseFloat(f[g].value));d.values[b]=a;if(c.callback){var h=c.callback.call(e,a);if("object"==typeof h&&2<=h.length){for(g=0;g<f.length;g++)$(f[g]).val(h[g]);a=h}}$(e).trigger("wchange",[a]);if(d.onchange)d.onchange(b,a,e)});this.append(e,
c);e.setValue=function(a){f.setValue(a[0]);h.setValue(a[1])};return e};
Inspector.prototype.addVector3=function(b,a,c){function g(a){this.callback_before&&this.callback_before()}c=this.processOptions(c);c.step||(c.step=0.1);a=a||[0,0,0];var d=this;this.values[b]=a;var e=this.createWidget(b,"",c);c.step=c.step||0.1;c.tab_index=this.tab_index;c.full=!0;this.tab_index++;var f=new LiteGUI.Dragger(a[0],c);f.root.style.marginLeft=0;f.root.style.width="calc( 33% - 3px )";$(e).find(".wcontent").append(f.root);c.tab_index=this.tab_index;this.tab_index++;var h=new LiteGUI.Dragger(a[1],
c);h.root.style.width="calc( 33% - 3px )";$(e).find(".wcontent").append(h.root);c.tab_index=this.tab_index;this.tab_index++;var l=new LiteGUI.Dragger(a[2],c);l.root.style.width="calc( 33% - 3px )";$(e).find(".wcontent").append(l.root);$(f.root).bind("start_dragging",g.bind(c));$(h.root).bind("start_dragging",g.bind(c));$(l.root).bind("start_dragging",g.bind(c));$(e).find("input").change(function(a){a=[];for(var f=$(e).find("input"),g=0;g<f.length;g++)a.push(parseFloat(f[g].value));d.values[b]=a;if(c.callback){var l=
c.callback.call(e,a);if("object"==typeof l&&3<=l.length){for(g=0;g<f.length;g++)$(f[g]).val(l[g]);a=l}}$(e).trigger("wchange",[a]);if(d.onchange)d.onchange(b,a,e)});this.append(e,c);e.setValue=function(a){f.setValue(a[0]);h.setValue(a[1]);l.setValue(a[2])};return e};
...
Inspector.prototype.addSlider=function(b,a,c){c=this.processOptions(c);void 0===c.min&&(c.min=0);void 0===c.max&&(c.max=1);void 0===c.step&&(c.step=0.01);var g=this;this.values[b]=a;var d=this.createWidget(b,"<span class='inputfield full'>\t\t\t\t<input tabIndex='"+this.tab_index+"' type='text' class='slider-text fixed nano' value='"+a+"' /><span class='slider-container'></span></span>",c),e=d.querySelector(".slider-container"),f=new LiteGUI.Slider(a,c);e.appendChild(f.root);var h=d.querySelector(".slider-text");
