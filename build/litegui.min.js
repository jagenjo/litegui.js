...
document.body.removeChild(f)}this.options=b=b||{};var d=this,f=document.createElement("div");f.className="litecontextualmenu litemenubar-panel";f.style.minWidth=100;f.style.minHeight=100;f.style.pointerEvents="none";setTimeout(function(){f.style.pointerEvents="auto"},100);this.root=f;for(var h in a){var l=document.createElement("div");l.className="litemenu-entry submenu";var m=a.constructor==Array?a[h]:h,p=a[h];l.innerHTML=p&&p.title?p.title:m;l.value=p;"function"==typeof p?(l.dataset.value=m,l.onclick_callback=
p):"object"==typeof p?p.callback&&l.addEventListener("click",function(a){this.value.callback.apply(this,this.value)}):l.dataset.value=p;f.appendChild(l);l.addEventListener("click",c)}f.addEventListener("mouseleave",function(a){document.body.removeChild(f)});document.body.appendChild(f);h=b.left||0;l=b.top||0;b.event&&(h=b.event.pageX-10,l=b.event.pageY-10,m=document.body.getClientRects()[0],h>m.width-$(f).width()-10&&(h=m.width-$(f).width()-10),l>m.height-$(f).height()-10&&(l=m.height-$(f).height()-
10));f.style.left=h+"px";f.style.top=l+"px"};LiteGUI.Checkbox=function(a,b){var c=this.root=document.createElement("span");c.className="litecheckbox inputfield";c.dataset.value=a;var d=this.element=document.createElement("span");d.className="fixed flag checkbox "+(a?"on":"off");c.appendChild(d);c.addEventListener("click",function(a){this.setValue("true"!=this.root.dataset.value);a.preventDefault();a.stopPropagation()}.bind(this));this.setValue=function(a){this.root.dataset.value!=a.toString()&&((this.root.dataset.value=
...
!1:!0)});c.on_change_callback=b;c.setEmpty=function(a){a?this.classList.add("empty"):this.classList.remove("empty")};c.setValue=function(a){this.dataset.value!=(a?"open":"closed")&&(a?(this.dataset.value="open",this.innerHTML="&#9660;",this.classList.add("listopen"),this.classList.remove("listclosed")):(this.dataset.value="closed",this.innerHTML="&#9658;",this.classList.remove("listopen"),this.classList.add("listclosed")),b&&b(this.dataset.value))};c.getValue=function(){return this.dataset.value};
return c};LiteGUI.List=function(a,b,c){c=c||{};var d=document.createElement("ul");this.root=d;d.id=a;d.className="litelist";this.items=[];var f=this;this.callback=c.callback;for(var h in b){a=document.createElement("li");a.className="list-item";a.data=b[h];var l="";"string"==typeof b[h]?l=b[h]+"<span class='arrow'></span>":(l=(b[h].name||b[h].title||"")+"<span class='arrow'></span>",b[h].id&&(a.id=b[h].id));a.innerHTML=l;d.appendChild(a)}$(d).find(".list-item").click(function(){$(d).find(".list-item.selected").removeClass("selected");
$(this).addClass("selected");$(f.root).trigger("wchanged",this);f.callback&&f.callback(this.data)});c.parent&&(c.parent.root?$(c.parent.root).append(d):$(c.parent).append(d))};LiteGUI.Slider=function(a,b){function c(a){var d=h.getClientRects()[0].width,g=b.min||0;l.setValue(a/d*((b.max||1)-g)+g)}function d(a){var b=h.getClientRects()[0];c((void 0===a.x?a.pageX:a.x)-b.left);a.preventDefault();return!1}function f(a){document.removeEventListener("mousemove",d);document.removeEventListener("mouseup",
f);a.preventDefault();return!1}b=b||{};var h=document.createElement("canvas");h.className="slider "+(b.extraclass?b.extraclass:"");h.width=100;h.height=1;h.style.position="relative";h.style.width="calc( 100% - 2em )";h.style.height="1.2em";this.root=h;var l=this;this.value=a;this.setValue=function(a){var c=h.getContext("2d"),d=b.min||0,g=b.max||1;a<d?a=d:a>g&&(a=g);d=(a-d)/(g-d);c.clearRect(0,0,h.width,h.height);c.fillStyle="#999";c.fillRect(0,0,h.width*d,h.height);c.fillStyle="#DA2";c.fillRect(h.width*
d-1,0,2,h.height);a!=this.value&&(this.value=a,$(this.root).trigger("change",a))};h.addEventListener("mousedown",function(a){var b;a.offsetX?b=a.offsetX:a.layerX&&(b=a.layerX);c(b);document.addEventListener("mousemove",d);document.addEventListener("mouseup",f)});this.setValue(a)};LiteGUI.LineEditor=function(a,b){function c(a){return[n.width*((k.xrange[1]-k.xrange[0])*a[0]+k.xrange[0]),n.height*((k.yrange[1]-k.yrange[0])*a[1]+k.yrange[0])]}function d(a){return[(a[0]/n.width-k.xrange[0])/(k.xrange[1]-
k.xrange[0]),(a[1]/n.height-k.yrange[0])/(k.yrange[1]-k.yrange[0])]}function f(a){var b=n.getBoundingClientRect(),c=a.clientX-b.left,e=a.clientY-b.top;0>c?c=0:c>n.width&&(c=n.width);0>e?e=0:e>n.height&&(e=n.height);if(-1!=q&&m([a.clientX-b.left,a.clientY-b.top],[c,e])>0.5*n.height)k.value.splice(q,1),h(a);else{b=d([-(t[0]-c),t[1]-e]);if(-1!=q){var g=k.xrange[0],f=k.xrange[1];k.no_trespassing&&(0<q&&(g=k.value[q-1][0]),q<k.value.length-1&&(f=k.value[q+1][0]));var s=k.value[q];s[0]+=b[0];s[1]+=b[1];
s[0]<g?s[0]=g:s[0]>f&&(s[0]=f);s[1]<k.yrange[0]?s[1]=k.yrange[0]:s[1]>k.yrange[1]&&(s[1]=k.yrange[1])}p();k.redraw();t[0]=c;t[1]=e;l();a.preventDefault();a.stopPropagation()}}function h(a){q=-1;k.redraw();$(document).unbind("mousemove",f);$(document).unbind("mouseup",h);l();a.preventDefault();a.stopPropagation()}function l(){b.callback?b.callback.call(k,k.value):$(k).change()}function m(a,b){return Math.sqrt(Math.pow(b[0]-a[0],2)+Math.pow(b[1]-a[1],2))}function p(){var a=null;-1!=q&&(a=k.value[q]);
k.value.sort(function(a,b){return a[0]>b[0]});a&&(q=k.value.indexOf(a))}b=b||{};var k=document.createElement("div");k.className="curve "+(b.extraclass?b.extraclass:"");k.style.minHeight="50px";k.style.width=b.width||"100%";k.bgcolor=b.bgcolor||"#222";k.pointscolor=b.pointscolor||"#5AF";k.linecolor=b.linecolor||"#444";k.value=a||[];k.xrange=b.xrange||[0,1];k.yrange=b.yrange||[0,1];k.defaulty=null!=b.defaulty?b.defaulty:0.5;k.no_trespassing=b.no_trespassing||!1;k.show_samples=b.show_samples||0;k.options=
b;var n=document.createElement("canvas");n.width=b.width||200;n.height=b.height||50;k.appendChild(n);k.canvas=n;$(n).bind("mousedown",function(a){$(document).bind("mousemove",f);$(document).bind("mouseup",h);for(var b=n.getBoundingClientRect(),e=a.clientX-b.left,b=a.clientY-b.top,l=n.height-b,v=1E5,w=-1,s=0;s<k.value.length;s++){var u=c(k.value[s]),u=m([e,l],u);u<v&&8>u&&(v=u,w=s)}q=w;-1==q&&(l=d([e,n.height-b]),k.value.push(l),p(),q=k.value.indexOf(l));t=[e,b];k.redraw();a.preventDefault();a.stopPropagation()});
$(k).resize(function(a){n.width=$(this).width();n.height=$(this).height();k.redraw()});k.getValueAt=function(a){if(a<k.xrange[0]||a>k.xrange[1])return k.defaulty;for(var b=[k.xrange[0],k.defaulty],c=0,c=0;c<k.value.length;c+=1){var e=k.value[c];if(a==e[0])return e[1];if(a<e[0])return c=(a-b[0])/(e[0]-b[0]),b[1]*(1-c)+e[1]*c;b=e}e=[k.xrange[1],k.defaulty];c=(a-b[0])/(e[0]-b[0]);return b[1]*(1-c)+e[1]*c};k.resample=function(a){var b=[];a=(k.xrange[1]-k.xrange[0])/a;for(var c=k.xrange[0];c<=k.xrange[1];c+=
a)b.push(k.getValueAt(c));return b};k.addValue=function(a){for(var b=0;b<k.value;b++)if(!(k.value[b][0]<a[0])){k.value.splice(b,0,a);redraw();return}k.value.push(a);redraw()};var q=-1;k.redraw=function(){var a=n.getContext("2d");a.setTransform(1,0,0,1,0,0);a.translate(0,n.height);a.scale(1,-1);a.fillStyle=k.bgcolor;a.fillRect(0,0,n.width,n.height);a.strokeStyle=k.linecolor;a.beginPath();var b=c([k.xrange[0],k.defaulty]);a.moveTo(b[0],b[1]);for(var e in k.value)b=k.value[e],b=c(b),a.lineTo(b[0],b[1]);
b=c([k.xrange[1],k.defaulty]);a.lineTo(b[0],b[1]);a.stroke();for(e=0;e<k.value.length;e+=1)b=k.value[e],b=c(b),a.fillStyle=q==e?"white":k.pointscolor,a.beginPath(),a.arc(b[0],b[1],q==e?4:2,0,2*Math.PI),a.fill();if(k.show_samples){var d=k.resample(k.show_samples);a.fillStyle="#888";for(e=0;e<d.length;e+=1)b=[(k.xrange[1]-k.xrange[0])/k.show_samples*e+k.xrange[0],d[e]],b=c(b),a.beginPath(),a.arc(b[0],b[1],2,0,2*Math.PI),a.fill()}};var t=[0,0];k.redraw();return k}})();
...
c.prototype.getTabContent=function(b){if(b=this.tabs[b])return b.content};c.prototype.getTabIndex=function(b){b=this.tabs[b];if(!b)return-1;for(var a=0;a<this.list.childNodes.length;a++)if(this.list.childNodes[a]==b.tab)return a;return-1};c.prototype.addTab=function(b,a){a=a||{};"function"==typeof a&&(a={callback:a});var e=this,g=document.createElement("LI");g.className="wtab wtab-"+b.replace(/ /gi,"_");g.data=b;g.innerHTML="<span class='tabtitle'>"+(a.title||b)+"</span>";a.bigicon&&(g.innerHTML=
"<img class='tabbigicon' src='"+a.bigicon+"'/>"+g.innerHTML);a.closable&&(g.innerHTML+="<span class='tabclose'>X</span>",g.querySelector("span.tabclose").addEventListener("click",function(a){e.removeTab(b);a.preventDefault();a.stopPropagation()},!0));a.index&&-1!=a.index?this.list.insertBefore(g,this.list.childNodes[a.index]):this.list.appendChild(g);var d=document.createElement("div");a.id&&(d.id=a.id);d.className="wtabcontent wtabcontent-"+b.replace(/ /gi,"_")+" "+(a.className||"");d.data=b;d.style.display=
...
d.style.width="-webkit-calc( 100% - "+LiteGUI.Tabs.tabs_width+"px )"):d.style.width=a.size);a.content&&("string"==typeof a.content?d.innerHTML=a.content:d.appendChild(a.content));this.root.appendChild(d);g.addEventListener("click",c.prototype.onTabClicked);g.options=a;g.tabs=this;this.list.appendChild(g);g={name:b,tab:g,content:d,add:function(a){this.content.appendChild(a.root||a)}};a.onclose&&(g.onclose=a.onclose);this.tabs[b]=g;!0!=a.selected&&null!=this.selected||this.selectTab(b);return g};c.prototype.onTabClicked=
function(){if(!this.classList.contains("selected")&&this.parentNode){var b=this.options,a=this.parentNode.parentNode.tabs;if(!a)throw"tabs not found";if(!b.callback_canopen||!1!=b.callback_canopen()){var c=this.data,g=null,d;for(d in a.tabs){var f=a.tabs[d];d==c?(f.selected=!0,$(f.content).show(),g=f.content):(delete f.selected,$(f.content).hide())}$(a.list).find("li.wtab").removeClass("selected");this.classList.add("selected");a.current_tab&&a.current_tab[0]!=c&&a.current_tab[2]&&a.current_tab[2].callback_leave&&
a.current_tab[2].callback_leave(a.current_tab[0],a.current_tab[1],a.current_tab[2]);a.current_tab=[c,g,b];b.callback&&b.callback(c,g);$(a).trigger("wchange",[c,g]);if(a.onchange)a.onchange(name,c,g);a.selected=name}}};c.prototype.selectTab=function(b){for(var a=this.list.querySelectorAll("li.wtab"),c=0;c<a.length;c++)if(b==a[c].data){$(a[c]).click();break}};c.prototype.setTabVisibility=function(b,a){var c=this.tabs[b];c&&(c.tab.style.display=a?"none":"inline-block",c.content.style.display=a?"none":
"inline-block")};c.prototype.removeTab=function(b){var a=this.tabs[b];if(a){if(a.onclose)a.onclose(a);a.tab.parentNode.removeChild(a.tab);a.content.parentNode.removeChild(a.content);delete this.tabs[b]}};c.prototype.hideTab=function(b){this.setTabVisibility(b,!1)};c.prototype.showTab=function(b){this.setTabVisibility(b,!0)};c.prototype.transferTab=function(b,a,c){var g=this.tabs[b];if(g){a.tabs[b]=g;void 0!==c?a.list.insertBefore(g.tab,a.list.childNodes[c]):a.list.appendChild(g.tab);a.root.appendChild(g.content);
...
d.document.close();var l=this,m=new LiteGUI.Tabs(null,this.options);d.tabs=m;d.onbeforeunload=function(){m.transferTab(b,l,g);c&&c()};m.list.style.height="20px";d.document.body.appendChild(m.root);l.transferTab(b,m);m.tabs[b].tab.classList.add("selected");a&&a();return d}};LiteGUI.Tabs=c})();
