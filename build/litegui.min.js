...
b);f.content.style.paddingBottom="10px";$(f.content).find("button").click(function(){var b="yes"==this.dataset.value;a&&a(b);f.close()});return f},prompt:function(c,a,b){b=b||{};b.className="alert";b.title="Prompt";b.width=280;"string"==typeof c&&(c="<p>"+c+"</p>");var f=b.value||"",e="<input type='text' value='"+f+"'/>";b.textarea&&(e="<textarea class='textfield' style='width:95%'>"+f+"</textarea>");b.noclose=!0;var d=this.showMessage(c+("<p>"+e+"</p><button data-value='accept' style='width:45%; margin-left: 10px; margin-bottom: 10px'>Accept</button><button data-value='cancel' style='width:45%'>Cancel</button>"),
b);$(d.content).find("button").click(function(){var f=$(d.content).find(b.textarea?"textarea":"input").val();"cancel"==this.dataset.value&&(f=null);a&&a(f);d.close()});$(d.content).find("input,textarea").focus();return d},getUrlVars:function(){for(var c=[],a,b=window.location.href.slice(window.location.href.indexOf("?")+1).split("&"),f=0;f<b.length;f++)a=b[f].split("="),c.push(a[0]),c[a[0]]=a[1];return c},getUrlVar:function(c){return LiteGUI.getUrlVars()[c]},trigger:function(c,a){var b=document.createEvent("CustomEvent");
b.initCustomEvent(c,!0,!0,!0);if(a.dispatchEvent)a.dispatchEvent(b);else throw"trigger can only be called in DOMElements";},draggable:function(c,a){function b(a){if("mousedown"==a.type)return d||(g=(d=c.getClientRects()[0])?d.left:0,h=d?d.top:0),f=a.clientX,e=a.clientY,document.addEventListener("mousemove",b),document.addEventListener("mouseup",b),a.stopPropagation(),a.preventDefault(),!1;if("mouseup"==a.type)document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",b);else if("mousemove"==
a.type){var m=a.clientX-f,p=a.clientY-e;f=a.clientX;e=a.clientY;g+=m;h+=p;c.style.left=g+"px";c.style.top=h+"px"}}a=a||c;a.addEventListener("mousedown",b);a.style.cursor="move";var f=0,e=0,d=c.getClientRects()[0],g=d?d.left:0,h=d?d.top:0;c.style.position="absolute";c.style.left=g+"px";c.style.top=h+"px"}};
function purgeElement(c,a){var b=c.attributes,f,e;if(b)for(f=b.length-1;0<=f;f-=1)e=b[f].name,"function"===typeof c[e]&&(c[e]=null);if(b=c.childNodes)for(b=b.length,f=0;f<b;f+=1)purgeElement(c.childNodes[f])}
...
this.root.removeChild(this.sections[1].root);this.sections=[];this._computed_size=null;this.resize()};a.prototype.add=function(b){if("string"==typeof b){var a=document.createElement("div");a.innerHTML=b;b=a}this.content.appendChild(b.root||b)};a.prototype.query=function(b){return this.root.querySelector(b)};LiteGUI.Area=a;LiteGUI.Split=function(b,a,c){c=c||{};var d=document.createElement("div");this.root=d;d.id=b;d.className="litesplit "+(c.vertical?"vsplit":"hsplit");this.sections=[];for(var g in a)b=
document.createElement("div"),b.className="split-section split"+g,"number"==typeof a[g]?c.vertical?b.style.height=a[g].toFixed(1)+"%":b.style.width=a[g].toFixed(1)+"%":"string"==typeof a[g]?c.vertical?b.style.height=a[g]:b.style.width=a[g]:(a[g].id&&(b.id=a[g].id),c.vertical?b.style.height="Number"==typeof a[g].height?a[g].height.toFixed(1)+"%":a[g].height:b.style.width="Number"==typeof a[g].width?a[g].width.toFixed(1)+"%":a[g].width),this.sections.push(b),d.appendChild(b);c.parent&&(c.parent.root?
c.parent.root.appendChild(d):c.parent.appendChild(d))};LiteGUI.ContextualMenu=function(b,a){this.options=a=a||{};var c=this,d=document.createElement("div");d.className="litecontextualmenu litemenubar-panel";d.style.minWidth=100;d.style.minHeight=100;this.root=d;for(var g in b){var h=document.createElement("div");h.className="litemenu-entry submenu";h.dataset.value=b[g];h.innerHTML=b.constructor==Array?b[g]:g;d.appendChild(h)}$(d).find(".litemenu-entry").click(function(b){b=this.dataset.value;a.callback&&
a.callback.call(c,b);document.body.removeChild(d)});$(d).mouseleave(function(b){document.body.removeChild(d)});document.body.appendChild(d);g=a.left||0;h=a.top||0;if(a.event){g=a.event.pageX-10;var h=a.event.pageY-10,k=document.body.getClientRects()[0];g>k.width-$(d).width()-10&&(g=k.width-$(d).width()-10);h>k.height-$(d).height()-10&&(h=k.height-$(d).height()-10)}d.style.left=g+"px";d.style.top=h+"px"};LiteGUI.createLitebox=function(b,a){var c=document.createElement("span");c.className="listbox "+
...
(function(){function c(a,b){b=b||{};var c=document.createElement("DIV");a&&(c.id=a);c.data=this;c.className="litetabs";this.root=c;this.root.tabs=this;this.current_tab=null;b.height&&(this.root.style.height="full"==b.height?"100%":b.height);c=document.createElement("UL");c.className="wtabcontainer";c.style.height=LiteGUI.Tabs.tabs_height+"px";this.list=c;this.root.appendChild(this.list);this.tabs={};this.selected=null;this.onchange=b.callback;b.parent&&this.appendTo(b.parent)}c.tabs_height="30px";
...
a.tab)return b;return-1};c.prototype.addTab=function(a,b){b=b||{};var f=document.createElement("LI");f.className="wtab wtab-"+a.replace(/ /gi,"_");f.data=a;f.innerHTML=a;b.index&&-1!=b.index?this.list.insertBefore(f,this.list.childNodes[b.index]):this.list.appendChild(f);var e=document.createElement("div");b.id&&(e.id=b.id);e.className="wtabcontent wtabcontent-"+a.replace(/ /gi,"_")+" "+(b.className||"");e.data=a;e.style.display="none";b.height&&(e.style.overflow="auto","full"==b.height?(e.style.height=
"calc( 100% - "+LiteGUI.Tabs.tabs_height+" )",e.style.height="-moz-calc( 100% - "+LiteGUI.Tabs.tabs_height+" )",e.style.height="-webkit-calc( 100% - "+LiteGUI.Tabs.tabs_height+" )"):e.style.height=b.height);b.content&&("string"==typeof b.content?e.innerHTML=b.content:e.appendChild(b.content));this.root.appendChild(e);f.addEventListener("click",c.prototype.onTabClicked);f.options=b;f.tabs=this;this.list.appendChild(f);this.tabs[a]={name:a,tab:f,content:e,add:function(b){this.content.appendChild(b.root||
b)}};!0!=b.selected&&null!=this.selected||this.selectTab(a);return this.tabs[a]};c.prototype.onTabClicked=function(){if(!this.classList.contains("selected")){var a=this.options,b=this.parentNode.parentNode.tabs;if(!b)throw"tabs not found";if(!a.callback_canopen||!1!=a.callback_canopen()){var c=this.data,e=null,d;for(d in b.tabs){var g=b.tabs[d];d==c?($(g.content).show(),e=g.content):$(g.content).hide()}$(b.list).find("li.wtab").removeClass("selected");this.classList.add("selected");b.current_tab&&
b.current_tab[0]!=c&&b.current_tab[2]&&b.current_tab[2].callback_leave&&b.current_tab[2].callback_leave(b.current_tab[0],b.current_tab[1],b.current_tab[2]);b.current_tab=[c,e,a];a.callback&&a.callback(c,e);$(b).trigger("wchange",[c,e]);if(b.onchange)b.onchange(name,c,e);b.selected=name}}};c.prototype.selectTab=function(a){for(var b=this.list.querySelectorAll("li.wtab"),c=0;c<b.length;c++)if(a==b[c].data){$(b[c]).click();break}};c.prototype.setTabVisibility=function(a,b){var c=this.tabs[a];c&&(c.tab.style.display=
b?"none":"inline-block",c.content.style.display=b?"none":"inline-block")};c.prototype.removeTab=function(a){var b=this.tabs[a];b&&(b.tab.parentNode.removeChild(b.tab),b.content.parentNode.removeChild(b.content),delete this.tabs[a])};c.prototype.hideTab=function(a){this.setTabVisibility(a,!1)};c.prototype.showTab=function(a){this.setTabVisibility(a,!0)};c.prototype.transferTab=function(a,b,c){var e=this.tabs[a];if(e){b.tabs[a]=e;void 0!==c?b.list.insertBefore(e.tab,b.list.childNodes[c]):b.list.appendChild(e.tab);
b.root.appendChild(e.content);delete this.tabs[a];c=null;for(var d in this.tabs){c=d;break}c&&this.selectTab(c);e.tab.classList.remove("selected");b.selectTab(a)}};c.prototype.detachTab=function(a,b,c){if(this.tabs[a]){var e=this.getTabIndex(a),d=window.open("","","width=800, height=600, location=no, status=no, menubar=no, titlebar=no, fullscreen=yes");d.document.write("<head><title>"+a+"</title>");for(var g=document.querySelectorAll("link[rel='stylesheet'],style"),h=0;h<g.length;h++)d.document.write(g[h].outerHTML);
d.document.write("</head><body></body>");d.document.close();var k=this;setTimeout(function(){var g=new LiteGUI.Tabs;d.tabs=g;d.onbeforeunload=function(){g.transferTab(a,k,e);c&&c()};g.list.style.height="20px";d.document.body.appendChild(g.root);k.transferTab(a,g);g.tabs[a].tab.classList.add("selected");b&&b()},1);return d}};LiteGUI.Tabs=c})();
(function(){LiteGUI.Dragger=function(c,a){function b(b){var c=[b.screenX-m.data[0],m.data[1]-b.screenY];m.data=[b.screenX,b.screenY];e(c[a.horizontal?0:1],b);b.stopPropagation();b.preventDefault();return!1}function f(a){$(d).trigger("stop_dragging");$(document).unbind("mousemove",b);$(document).unbind("mouseup",f);$(m).trigger("blur");a.stopPropagation();a.preventDefault();return!1}function e(b,c){var f=a.step?a.step:1;c&&c.shiftKey?f*=10:c&&c.ctrlKey&&(f*=0.1);f=parseFloat(k.value)+b*f;null!=a.max&&
f>a.max&&(f=a.max);null!=a.min&&f<a.min&&(f=a.min);k.value=a.precision?f.toFixed(a.precision):(1E3*f<<0)/1E3;a.units&&(k.value+=a.units);$(k).change()}a=a||{};var d=document.createElement("div");d.className="dragger "+(a.extraclass?a.extraclass:"");this.root=d;var g=document.createElement("span");g.className="inputfield "+(a.extraclass?a.extraclass:"")+(a.full?" full":"");a.disabled&&(g.className+=" disabled");d.appendChild(g);var h=a.dragger_class||"full",k=document.createElement("input");k.className=
...
(function(){function c(a,b,c){var e=document.createElement("div");this.root=e;a&&(e.id=a);e.className="litetree";this.tree=b;this.options=c=c||{allow_rename:!0,drag:!0};a=this.createTreeItem(b,c);a.className+=" root_item";this.root.appendChild(a);this.root_item=a}c.prototype.updateTree=function(a){this.root_item&&$(this.root_item).remove();a&&(a=this.createTreeItem(a,this.options),a.className+=" root_item",this.root.appendChild(a),this.root_item=a)};c.prototype.createTreeItem=function(a,b){var c=
document.createElement("li");c.className="ltreeitem";if(a.id){var e=a.id.replace(/\s/g,"_");c.className+=" ltreeitem-"+e;c.dataset.item_id=a.id}c.data=a;a.DOM=c;b=b||this.options;var d=document.createElement("div");d.className="ltreeitemtitle";a.className&&(d.className+=" "+a.className);d.innerHTML="<span class='precontent'></span><span class='incontent'>"+(a.content||a.id||"")+"</span><span class='postcontent'></span>";if(a.dataset)for(var g in a.dataset)c.dataset[g]=a.dataset[g];c.appendChild(d);
c.title_element=d;e=$(c).find(".ltreeitemtitle .incontent");e.click(function(b){b=this.parentNode;var a=b.parentNode;if(!b._editing){$(k.root).removeClass("selected");$(k.root).find(".ltreeitemtitle.selected").removeClass("selected");b.classList.add("selected");$(k.root).trigger("item_selected",[a.data,a]);if(k.onItemSelected)k.onItemSelected(a.data,a);a.callback&&a.callback.call(k,a)}});e.dblclick(function(b){var a=this.parentNode;$(k.root).trigger("item_dblclicked",[a.data,a]);if(!this._editing&&
k.options.allow_rename){this._editing=!0;this._old_name=this.innerHTML;var c=this;this.innerHTML="<input type='text' value='"+this.innerHTML+"' />";var d=$(this).find("input")[0];$(d).blur(function(b){var d=b.target.value;setTimeout(function(){c.innerHTML=d},1);delete c._editing;$(k.root).trigger("item_renamed",[c._old_name,d,a]);delete c._old_name});$(d).bind("keydown",function(b){13==b.keyCode&&$(this).blur()});$(d).focus();b.preventDefault()}});e[0].addEventListener("contextmenu",function(b){if(k.onContextMenu&&
2==b.button&&k.onContextMenu)k.onContextMenu(b);b.preventDefault();return!1});e=document.createElement("ul");e.className="ltreeitemchildren";c.children_element=e;c.list=e;if(a.children)for(g in a.children){var h=this.createTreeItem(a.children[g],b);e.appendChild(h)}c.appendChild(e);this.updateListBox(c);var k=this;d.draggable=!0;d.addEventListener("dragstart",function(b){b.dataTransfer.setData("item_id",this.parentNode.dataset.item_id)});d.addEventListener("dragenter",function(b){b.preventDefault();
if(a.skipdrag)return!1;d.classList.add("dragover")});d.addEventListener("dragleave",function(b){b.preventDefault();d.classList.remove("dragover")});d.addEventListener("dragover",function(b){b.preventDefault()});d.addEventListener("drop",function(b){$(d).removeClass("dragover");b.preventDefault();if(a.skipdrag)return!1;var c=b.dataTransfer.getData("item_id");if(""!=c)try{var f=this.parentNode.dataset.item_id;(!k.onMoveItem||k.onMoveItem&&!1!=k.onMoveItem(k.getItem(c),k.getItem(f)))&&k.moveItem(c,f)&&
$(k.root).trigger("item_moved",[k.getItem(c),k.getItem(f)])}catch(e){console.error("Error: "+e)}else $(k.root).trigger("drop_on_item",[this,b])});return c};c.prototype.filterByName=function(a){for(var b=this.root.querySelectorAll(".ltreeitemtitle .incontent"),c=0;c<b.length;c++){var e=b[c];if(e){var d=e.innerHTML,e=e.parentNode;a&&-1==d.indexOf(a)?(e.style.display="none",e.parentNode.style.paddingLeft=0):(e.style.display="block",e.parentNode.style.paddingLeft=null)}}};c.onClickBox=function(a){a=this.children_element;
a.style.display="none"==a.style.display?"block":"none"};c.prototype.getItem=function(a){a=a.replace(/\s/g,"_");a=this.root.querySelector(".ltreeitem-"+a);if(!a)return null;if(!a.classList.contains("ltreeitem"))throw"this node is not a tree item";return a};c.prototype.expandItem=function(a){(a=this.getItem(a))&&a.listbox&&listbox.setValue(!0)};c.prototype.contractItem=function(a){(a=this.getItem(a))&&a.listbox&&listbox.setValue(!1)};c.prototype.setSelectedItem=function(a){if(a){a=this.getItem(a);if(!a)return null;
if(a.classList.contains("selected"))return a;$(this.root).removeClass("selected");$(this.root).find(".ltreeitemtitle.selected").removeClass("selected");$(a.title_element).addClass("selected");return a}$(this.root).removeClass("selected");$(this.root).find(".ltreeitemtitle.selected").removeClass("selected")};c.prototype.getSelectedItem=function(){return this.root.querySelector(".ltreeitemtitle.selected")};c.prototype.insertItem=function(a,b,c,e){var d=this.root_item;if(b&&(d="string"==typeof b?this.getItem(b):
b,!d))return null;if(!d.classList.contains("ltreeitem"))throw"this node is not a tree item";a=this.createTreeItem(a,e);void 0==c?d.list.appendChild(a):d.list.insertBefore(a,d.list.childNodes[c]);this.updateListBox(d);return a};c.prototype.updateListBox=function(a){if(!a.listbox){var b=a.title_element.querySelector(".precontent"),f=LiteGUI.createLitebox(!0,c.onClickBox.bind(a));f.setEmpty(!0);b.appendChild(f);a.listbox=f}(b=this.getChildren(a))&&(b.length?a.listbox.setEmpty(!1):a.listbox.setEmpty(!0))};
c.prototype.getChildren=function(a){"string"==typeof a&&this.getItem(a);if(!a||!a.list)return null;a=a.list.childNodes;var b=[],c;for(c in a){var e=a[c];"li"==e.localName&&e.classList.contains("ltreeitem")&&b.push(e)}return b};c.prototype.getParent=function(a){"string"==typeof a&&this.getItem(a);if(!a)return null;for(a=a.parentNode;a;){if(a.classList.contains("ltreeitem"))return a;a=a.parentNode}return null};c.prototype.moveItem=function(a,b){var c=this.getItem(b),e=this.getItem(a),d=this.getParent(e);
if(!c||!e)return!1;if(c!=d)return c.list.appendChild(e),this.updateListBox(c),d&&this.updateListBox(d),!0};c.prototype.removeItem=function(a){var b=a;"string"==typeof a&&(b=this.getItem(a));if(!b)return null;(a=this.getParent(b))&&a.list&&(a.list.removeChild(b),a&&this.updateListBox(a))};c.prototype.updateItem=function(a,b){var c=this.getItem(a);c&&(c.data=b,b.id&&(c.id=b.id),b.content&&(c.title_element.querySelector(".incontent").innerHTML=b.content))};c.prototype.clear=function(a){$(a?this.root_item:
...
!0,LiteGUI.draggable(a,a.querySelector(".panel-header")));b.resizable&&this.setResizable();a=null;b.parent&&(a="string"==typeof b.parent?document.querySelector(b.parent):b.parent);a||(a=LiteGUI.root);a.appendChild(this.root);this.center()};a.prototype.setResizable=function(){function a(e){if("mousedown"==e.type)document.body.addEventListener("mousemove",a),document.body.addEventListener("mouseup",a),d[0]=e.pageX,d[1]=e.pageY;else if("mousemove"==e.type){var k=$(c).height()-(d[1]-e.pageY);$(c).height(k+
"px");d[0]=e.pageX;d[1]=e.pageY;g.content.style.height="calc( 100% - 24px )"}else"mouseup"==e.type&&(document.body.removeEventListener("mousemove",a),document.body.removeEventListener("mouseup",a));e.preventDefault();return!1}if(!this.resizable){var c=this.root;this.resizable=!0;var e=this.footer;e.style.minHeight="4px";$(e).addClass("resizable");e.addEventListener("mousedown",a);var d=[0,0],g=this}};a.prototype.dockTo=function(a,c){if(a){var e=this.root;c=c||"full";a=a.content||a;e.style.top=0;e.style.left=
0;e.style.boxShadow="0 0 0";if("full"==c)e.style.position="relative",e.style.width="100%",e.style.height="100%",this.content.style.width="100%",this.content.style.height="calc(100% - "+LiteGUI.Panel.title_height+")",this.content.style.height="-moz-calc(100% - "+LiteGUI.Panel.title_height+")",this.content.style.height="-webkit-calc(100% - "+LiteGUI.Panel.title_height+")",this.content.style.overflow="auto";else if("left"==c||"right"==c)e.style.position="absolute",e.style.top=0,e.style[c]=0,e.style.width=
this.width+"px",e.style.height="100%",this.content.style.height="-moz-calc(100% - "+LiteGUI.Panel.title_height+")",this.content.style.height="-webkit-calc(100% - "+LiteGUI.Panel.title_height+")",this.content.style.height="calc(100% - "+LiteGUI.Panel.title_height+")",this.content.style.overflow="auto","right"==c&&(e.style.left="auto",e.style.right=0);else if("bottom"==c||"top"==c)e.style.width="100%",e.style.height=this.height+"px","bottom"==c&&(e.style.bottom=0,e.style.top="auto");this.draggable&&
$(e).draggable({disabled:!0});a.content?a.content.appendChild(e):"string"==typeof a?$(a).append(e):a.appendChild(e)}};a.prototype.addButton=function(a,c){var e=this,d=document.createElement("button");d.innerHTML=a;c.className&&(d.className=c.className);$(this.root).find(".panel-footer").append(d);$(d).bind("click",function(a){c.callback&&c.callback(this);c.close&&e.close()});return d};a.prototype.close=function(){$(this.root).remove();$(this).trigger("closed")};a.minimized=[];a.prototype.minimize=
...
function(a,c){this.root.parentNode||LiteGUI.add(this);$(this.root).show();$(this).trigger("shown")};a.prototype.hide=function(a,c){$(this.root).hide();$(this).trigger("hidden")};a.prototype.setPosition=function(a,c){this.root.position="absolute";this.root.style.left=a+"px";this.root.style.top=c+"px"};a.prototype.setSize=function(a,c){this.root.style.width=a+"px";this.root.style.height=c+"px"};a.prototype.center=function(){this.root.position="absolute";this.root.style.left=Math.floor(0.5*($(this.root.parentNode).width()-
$(this.root).width()))+"px";this.root.style.top=Math.floor(0.5*($(this.root.parentNode).height()-$(this.root).height()))+"px"};a.prototype.adjustSize=function(){this.content.style.height="auto";var a=$(this.content).width(),c=$(this.content).height()+20;this.setSize(a,c)};LiteGUI.Panel=c;LiteGUI.Dialog=a})();jQuery.fn.wchange=function(c){$(this[0]).on("wchange",c)};jQuery.fn.wclick=function(c){$(this[0]).on("wclick",c)};
